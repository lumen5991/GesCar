<div class="container">
    <div>
        <a href="{{route('print_client')}}" class="btn btn-car ">Imprimer la liste des clients</a>
    </div>
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="align-middle">
                        <a href="{{ route('modifycusto', ['id_client' => $item['id_client']])  }}" class="btn" style="color: #470046;"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit">
